export const header = `
  <header class="SiteHeader_core-header__zJj3x SiteHeader_bg-ivory-medium__eqFO7" style="background-color: #faf9f5;">
    <div class="SiteHeader_wrapper__7LSsB wrapper">
      <a class="SiteHeader_core-logo-link__kHrqG" aria-label="Home" href="/">
        <div class="SiteHeader_logo-lottie__RQDnP">
          <h1 style="font-weight: bold;">Gatara AI</h1>
        </div>
      </a>
      <button class="SiteHeader_btn-core-mobile__tgSp1" aria-label="Navigation menu">
      ...
      <nav class="SiteHeader_core-nav__dsHuH">
        <div class="SiteHeader_claude-select__1ZKkq">
          <a href="#">
            <span class="SiteHeader_link-label__s59w1">Murshed</span>
        ...
        <a class="SiteHeader_link-label__s59w1" href="/products">Products</a>
        <a class="SiteHeader_link-label__s59w1" href="/company">Company</a>
        <a class="SiteHeader_link-label__s59w1" href="/jobs">Careers</a>
        <a href="#" class="ButtonLink_button__hVduT ButtonLink_primary__yV6bX ButtonLink_small__4mz6F SiteHeader_nav-cta-a__e5H8v" rel="noopener" target="_blank" aria-label="Try Claude">
          <span class="ButtonLink_label__DqhYH">Get a Demo</span>
        </a>
      </nav>
    </div>
  </header>
